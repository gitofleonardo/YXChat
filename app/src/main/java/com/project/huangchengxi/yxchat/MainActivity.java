...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        messageTextContent=(EditText)findViewById(R.id.input_edit_message_text);
        LoginLayout=(LinearLayout) findViewById(R.id.login_layout);
        MainLayout=(LinearLayout)findViewById(R.id.main_form_layout);
        ChattingLayout=(LinearLayout)findViewById(R.id.chatting_layout);
        ...
        recyclerViewMsg=(RecyclerView)MsgView.findViewById(R.id.recycler_view_message);
        recyclerViewUser=(RecyclerView)UserView.findViewById(R.id.recycler_view_ol_user);
        recyclerViewMsgDetail=(RecyclerView)findViewById(R.id.chatting_recycler_view);
